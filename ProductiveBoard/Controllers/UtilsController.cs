    ...
    public class UtilsController : Controller
    {
        ...
        public IActionResult About()
        {
            ...
            var locations = new List<Locations>()
            {
                ...
                new Locations(2, "Ido Philip - IdoPhilip@gmail.com","Bat Yam, israel", 32.011850, 34.745310),
                new Locations(3, "Dan Feithlicher - DanFeith@gmail.com","Rishon Lezion, israel", 31.963760, 34.815720),
                new Locations(3, "Itamar Higani - iHigani@gmail.com","Rishon Lezion, israel", 31.965760, 34.815320),
